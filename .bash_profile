...
ansible-vault decrypt --vault-password-file=~/.vault.txt "${ELISE_ROOT_DIR}/src/elise.sh"
...
HIST_PROMPT="\[${SHELL_CWD_PROMPT_CODE}\]\!\[${ECHO_RESET}\]"
