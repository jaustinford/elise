...
alias a_playbook_haproxy_restart="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"container_state=started recreate_container=yes\""
alias a_playbook_haproxy_start="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"container_state=started recreate_container=no\""
alias a_playbook_haproxy_stop="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"container_state=stopped recreate_container=no\""
...
alias a_playbook_ssl="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/ssl.yml"
