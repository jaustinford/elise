...
alias a_haproxy_reload="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"haproxy_reload=yes\""
alias a_haproxy_restart="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"haproxy_reload=no container_state=started recreate_container=yes message=restarting\""
alias a_haproxy_start="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"haproxy_reload=no container_state=started recreate_container=no message=starting\""
alias a_haproxy_stop="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/haproxy.yml --extra-vars \"haproxy_reload=no container_state=stopped recreate_container=no message=stopping\""
alias a_k8s_cluster_destroy="ansible-playbook ${ELISE_ROOT_DIR}/ansible/playbooks/k8s_cluster_destroy.yml"
